...
class LinterPosNormalizationTest(unittest.TestCase):
    ...
    def test_strips_state_and_case_markers_for_validation(self) -> None:
        ...
        self.assertEqual(
            normalize_pos_option_for_validation("PN m. sg. abs. voc."),
            "pn",
        )
    ...
    def test_strips_attached_affix_tail_for_validation(self) -> None:
        ...
        self.assertEqual(normalize_pos_option_for_validation("n. m. sg. abs. nom + encl. -m"), "n")
        self.assertEqual(
            normalize_pos_option_for_validation("n. f. du. cstr. gen. + 3 f. sg. suff."), "n"
        )
        self.assertEqual(normalize_pos_option_for_validation("prep. + 2 m. sg. suff."), "prep.")
        self.assertEqual(
    ...
    def test_strips_directional_morphology_before_validating_noun_head(self) -> None:
        self.assertEqual(normalize_pos_option_for_validation("n. f. sg. abs. acc. + dir. -h"), "n")
    ...
    def test_strips_person_number_gender_from_personal_pronoun(self) -> None:
        self.assertEqual(
            normalize_pos_option_for_validation("pers. pn. 1 c. sg."),
            "pers. pn",
        )
        self.assertTrue(pos_option_matches_allowed("pers. pn. 1 c. sg.", {"pers. pn"}))
    ...
    def test_affix_bearing_option_matches_coarse_dulat_label(self) -> None:
        ...
        self.assertTrue(pos_option_matches_allowed("prep. + 3 m. sg. suff.", {"prep."}))
