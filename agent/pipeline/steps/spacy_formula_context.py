"""Integrated spaCy-backed replacement for formula bigram/trigram steps."""
...
class SpacyFormulaContextDisambiguator(RefinementStep):
    """Apply formula bigram/trigram normalization in one row-level pass."""

    def __init__(self) -> None:
        self._nlp = create_ugaritic_formula_context_nlp()

    @property
    def name(self) -> str:
        return "spacy-formula-context"
