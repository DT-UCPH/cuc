"""Late exact-citation quote-translation tie-breaker."""
...
class SpacyQuoteTranslationDisambiguator(RefinementStep):
    """Apply generic quote-translation tie-breaking after stronger rules."""

    def __init__(self, dulat_db: Path | None = None) -> None:
        self._nlp = create_ugaritic_quote_translation_nlp(dulat_db=dulat_db)

    @property
    def name(self) -> str:
        return "spacy-quote-translation"
